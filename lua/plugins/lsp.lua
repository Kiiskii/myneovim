return {
	...
	-- Core LSP setup with Mason and nvim-cmp
	{
	...
	-- Formatter
	{
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				local lsp_opt = disable[vim.bo[bufnr].filetype] and "never" or "fallback"
				return { timeout_ms = 500, lsp_format = lsp_opt }
			end,
			formatters_by_ft = {
				lua = { "stylua" },
			},
	...
	-- Completion
	{
		...
		config = function()
			...
			cmp.setup({
				...
				experimental = {
					ghost_text = { hl_group = "CmpGhostText" }, -- shows inline ghost preview
				},
